...
import static com.github.komelgman.kompot.mixin4j.exception.MixinNotFoundException.mixinNotFoundExceptionMessage;
...
public class MixinManager implements Mixable, Mixed {
    ...
    public <T> T as(Class<T> descriptor) {
        ...
        if (mixin == null && log.isDebugEnabled()) {
            log.debug(mixinNotFoundExceptionMessage(this, descriptor));
        }
